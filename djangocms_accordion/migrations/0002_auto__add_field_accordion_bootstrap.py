...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Accordion.bootstrap'
        db.add_column(u'cmsplugin_accordion', 'bootstrap',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Accordion.bootstrap'
        db.delete_column(u'cmsplugin_accordion', 'bootstrap')
    ...
    models = {
        ...
        u'djangocms_accordion.accordion': {
            ...
            'bootstrap': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
